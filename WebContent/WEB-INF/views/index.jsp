                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">CSV 파일 저장</div>
                                            <form id="excelUploadForm" name="excelUploadForm" enctype="multipart/form-data" method="post" action= "${root}/csvUpload">
                                                <div class="contents">
                                                    <dl class="vm_name">
...
<%--                                                <div class="col-auto">--%>
                                                    <button type="button" id="addExcelImpoartBtn" class="btn-success" onclick="check()" >추가</button>
<%--                                                </div>--%>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="${root}/resources/img/undraw_posting_photo.svg" alt="">
                                    </div>
